...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Use AuthContext login to persist both token and user data
            login(res.data)
            navigate("/dashboard")
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-950 via-purple-900 to-indigo-900 px-4 relative overflow-hidden">
            ...
            <div className="absolute top-[-120px] left-[-80px] w-[400px] h-[400px] bg-purple-500/20 rounded-full blur-3xl animate-pulse" />
            <div className="absolute bottom-[-100px] right-[-60px] w-[350px] h-[350px] bg-indigo-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl shadow-purple-900/30">
                    ...
                    <p className="text-purple-200/60 text-sm mb-6">Sign in to your account</p>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-semibold py-3.5 rounded-xl hover:from-purple-600 hover:to-indigo-600 focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:ring-offset-2 focus:ring-offset-transparent transition-all duration-200 shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
                        >
                            {loading ? (
